...
## ***<p style="text-align:center">Метод Эйлера и Рунге-Кута для полёта тела в атмосфере</p>***
### <p style="text-align:center">Математическая модель</p>
...
m - масса\ тела,\\
C - коэффициент\ лобового\ сопротивления (C ≈ 0.15)\\
...
$$
\begin{aligned}
\text {Используя выражения выше после апроксимации} \frac{dV(t + ∆t)}{dt} = \frac{V(t + ∆t) - V(t)}{∆t} \text {получаем:}\\
...
***
# **<p style="text-align:center">Демонстрация результатов работы программы</p>**
...
## **<p style="text-align:center">График</p>**
...
Для <strong>практических</strong> расчетов можно выбрать шаг dt = 0.01. <strong>Дальнейшее</strong> уменьшение шага (на порядок и более) при использовании методов Эйлера или Рунге-Кутты приведет к <strong>существенному росту</strong> вычислительных затрат, <strong>не обеспечивая при этом заметного улучшения точности</strong> по сравнению с выбранным значением.
</p>
